...
\begin{Def}
集合$A,B$の二項関係$f$について,
任意の$a\in A$に, 対応する$b\in B$が一意に存在して$(a,b)\in\mathrm{f}$となるとき,
{\bf 二項関係$R$は集合$f$から集合$B$への写像map\index{しゃぞう@写像}である}という.
\end{Def}
\begin{Notation}
...
\subsection{合成と結合律}
\begin{Def}
二項関係$F\in A\times B$と$G\in B\times C$に対する
\[
\{(a,c)\in A\times C|\text{とある}b\in B\text{が存在して}(a,b)\in F \text{かつ} (b,c)\in G\text{である}\}
\]
を{\bf 二項関係$F\in A\times B$と$G\in B\times C$の合成 composition}という.
\end{Def}
\begin{Notation}
二項関係$F\in A\times B$と$G\in B\times C$の合成を$G\circ F$で表す.
\end{Notation}
\begin{Prop}
二項関係$F\in A\times B ,G\in B\times C, H\in C\times D$について
\[
...
\end{Prop}
\begin{Def}
写像$f:A\rightarrow B$と$g:B\rightarrow C$の合成して得られる写像を
